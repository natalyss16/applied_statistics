...
ggarrange(res_fit, qq, scale, ncol = 1, nrow = 3)
```
...
ggarrange(price_hist, log_price_hist, labels = c("price", "log_price"), ncol = 1, nrow = 2)
```
...
```{r}
model_log_price <- lm(log_price ~ bedrooms + bathrooms + sqft_living +
  floors + view + condition + grade + yr_built,
  data = house)
