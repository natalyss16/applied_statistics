...
First we'd like to specify the analysed variable to add more flexibility in the further analysis, when we'll need to make the same calculation for another variable.
